...
param(
    [Parameter()]
    [string]$Repository = "Chris-Wolfgang/ETL-SqlBulkCopy",
...
if ($Repository -eq "Chris-Wolfgang/ETL-SqlBulkCopy" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "Chris-Wolfgang/ETL-SqlBulkCopy") {
